...
function MeetTeam() {
  return (
    <div className="my-5 bg-dark-subtle">
      <div className="container px-3 py-3">
        <div className="row center mx-4 my-4 text-danger text-center">
          ...
          <div className="col-md-4 col-sm-6 col-12">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">A professional web designer with a wealth of knowledge about Software Development.</p>
